...
namespace BTApp.Migrations
{
    ...
    [Migration("20181116131732_employee_requestId")]
    partial class employee_requestId
    {
            ...
            modelBuilder.Entity("BTApp.Models.Request", b =>
                {
                    b.HasOne("BTApp.Models.Project")
                        .WithOne("Request")
                        .HasForeignKey("BTApp.Models.Request", "ProjectId");

                    b.HasOne("BTApp.Models.Subproject")
                        .WithOne("Request")
                        .HasForeignKey("BTApp.Models.Request", "SubprojectId");
                });
